...
public class SWTFactory {
	...
	public static void showPreferencePage(String id) {
		PreferencesUtil.createPreferenceDialogOn(WIDEUIPlugin.getShell(), id, new String[] {id}, null).open();
	}
	...
	public static void showPreferencePage(String page_id, String[] page_filters) {
		PreferencesUtil.createPreferenceDialogOn(WIDEUIPlugin.getShell(), page_id, page_filters, null).open();
	}
	...
	public static void showPropertyPage(IAdaptable element, String page_id, String[] page_filters) {
		PreferencesUtil.createPropertyDialogOn(WIDEUIPlugin.getShell(), element, page_id, page_filters, null).open();
	}
}
