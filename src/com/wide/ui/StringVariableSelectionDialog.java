...
public class StringVariableSelectionDialog extends ElementListSelectionDialog {
	...
	private void updateElements() {
		final Display display = WIDEUIPlugin.getStandardDisplay();
	...
	private boolean showVariablesPage() {
		WIDEHostConfigurationPreferencePage page = new WIDEHostConfigurationPreferencePage();
		...
		final PreferenceDialog dialog = new PreferenceDialog(WIDEUIPlugin.getShell(), manager);
		final boolean [] result = new boolean[] { false };
		BusyIndicator.showWhile(WIDEUIPlugin.getStandardDisplay(), () -> {
			dialog.create();
	...
	protected void handleSelectionChanged() {
		...
		if (text == null) {
			text = IInternalWIDECoreConstants.EMPTY_STRING;
		}
	...
	private String getDialogSettingsSectionName() {
		return WIDEUIConstants.PLUGIN_ID + ".STRING_VARIABLE_SELECTION_DIALOG_SECTION"; //$NON-NLS-1$
	}
	...
	protected IDialogSettings getDialogBoundsSettings() {
    	 IDialogSettings settings = WIDEUIPlugin.getDefault().getDialogSettings();
