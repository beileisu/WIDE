...
public class SFTPv3DirectoryEntry
{
	...
	public void setAttributes(SFTPv3FileAttributes attributes) {
		this.attributes = attributes;
	}

	public Integer getModifyTime() {
		return getAttributes().getMtime();
	}

	public String getModifyDateTime() {

		Integer second = getModifyTime();

		System.out.println("second: "+ second);

		Long millil = Long.valueOf(second * 1000L);

		System.out.println("millil: "+ millil);

        Instant instant = Instant.ofEpochMilli(millil);
